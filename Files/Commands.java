      ...
      if(input.equals(movieName)){
        ...
        if(movie.getHave() == 0){
          ...
          if(decision.equals("y") || decision.equals("Y")){
            ...
            if(customer.getFirstName().equals("") || customer.getLastName().equals("") || customer.getPhone().equals("")){
            ...
            System.out.println("Succesfully added '" + customer.getFirstName() + "' to the '" + movieName + "' waitlist.");
